...
import GlobalNodeHealth from '@/components/admin/GlobalNodeHealth';
...
export default function AdminDashboard() {
    ...
    const refreshAdminData = useCallback(() => {
        ...
        fetch('/api/admin/users/pending', { cache: 'no-store' }).then(res => res.json()).then(data => {
            if (data.success) setPendingUsers(data.data);
        });
        fetch('/api/admin/proposals', { cache: 'no-store' }).then(res => res.json()).then(data => {
            if (data.success) setProposals(data.data);
        });
        fetch('/api/admin/metrics', { cache: 'no-store' }).then(res => res.json()).then(data => {
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        { label: 'Ledger', icon: Shield, href: '/dashboard/admin/finances' },
